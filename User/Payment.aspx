<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="FoodOrderingSystem.User.Payment" %>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" Display="Dynamic"
                                                        ErrorMessage="Expiry month must be valid." ForeColor="Red" SetFocusOnError="true"
                                                        ValidationExpression="^(0?[1-9]|1[012])$" ControlToValidate="txtExpMonth" ValidationGroup="card">
                                                        *
                                                    </asp:RegularExpressionValidator>
